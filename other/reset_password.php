<?php
    ...
    $sqlDefaultPassword = "SELECT a.award_no, a.title, a.fname, a.mname, a.lname, a.def_password, a.email, b.hei_name, b.hei_uii, b.hei_region_nir FROM tbl_lbp_form a INNER JOIN tbl_heis b ON a.hei_uii = b.hei_uii WHERE award_no = '".$awardno."'";
