<!-- Modal -->
<div id="datFileModalGrantee" class="modal fade">  
    <div class="modal-dialog modal-lg modal_large">  
        <div class="modal-content">  
            <div class="modal-header" style="background-image:url('image/modal-heading.png');background-size:cover;text-align:center;"> 
                <h4 class="modal-title">DAT File Grantee Details</h4>  
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>  
            <div class="modal-body" id="datfile_grantee_detail" style="background-color:#616161">
            </div>  
