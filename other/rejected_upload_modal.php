<!-- Modal -->
<div id="modalbot_rejected_update_wallet" class="modal fade">  
                    ...
                    <form action="other/update_data.php" method="POST" enctype="multipart/form-data">
                        <div class="row" style="margin-top:10px;">
                            <div class="col">
                                ...
                                <input type="file" class="file_application_rejected_report" id="file_application_rejected_report" name="file_application_rejected_report">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col" style="text-align:center;padding-top:30px;">
                                <input type="submit" class="btn btn-info btn_update_rejected_records" name="btn_update_rejected_records" id="btn_update_rejected_records" value="Update Records" style="width:90%;">
                            </div>
                        </div>
                    </form>
                </div>  
