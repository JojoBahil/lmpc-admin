<!-- Modal -->
<div id="modalbot_revert_to_subtounifast" class="modal fade">  
    <div class="modal-dialog modal-lg modal_small" role="document">  
            <div class="modal-content">  
                <div class="modal-header" style="background-image:url('image/modal-heading.png');background-size:cover;text-align:center;"> 
                    <h5 class="modal-title">SubtoUniFAST Revert Excel File</h5>  
                    ...
                    <form action="other/update_data.php" method="POST" enctype="multipart/form-data">
                        <div class="row" style="margin-top:10px;">
                            <div class="col">
                                ...
                                <input type="file" class="file_application_subtounifast_revert" id="file_application_subtounifast_revert" name="file_application_subtounifast_revert">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col" style="text-align:center;padding-top:30px;">
                                <input type="submit" class="btn btn-info btn_update_revert_records" name="btn_update_revert_records" id="btn_update_revert_records" value="Update Records" style="width:90%;">
                            </div>
                        </div>
                    </form>
                </div>  
